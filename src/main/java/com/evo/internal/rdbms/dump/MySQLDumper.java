...
public class MySQLDumper extends AbstractDump implements IDumperPerRdbms {
	...
	public MySQLDumper(String dbUser, String dbPassword, int dbPort) {
		this.dbUser = dbUser;
	...
	private String dumpSchemas(List<String> schemas, boolean withData) throws SqlDumperException {
		return super.dump(
				"mysqldump" +
						...
						" --add-drop-database" // Add DROP DATABASE before each CREATE DATABASE
		);
	}
